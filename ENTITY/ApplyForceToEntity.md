...
void APPLY_FORCE_TO_ENTITY(Entity entity, Vector3 forceType, int x, float y, float z, float offX, float offY, float offZ, int boneIndex, BOOL isDirectionRel, BOOL ignoreUpVec, BOOL isForceRel, BOOL p12, BOOL p13);
```
